...
namespace Inlook_API.Controllers
{
    ...
    public class AttachmentController : BaseController
    {
        ...
        public AttachmentController(ILogger<AttachmentController> logger, TelemetryClient telemetryClient, IAttachmentService attachmentService)
        ...
        {
            var file = await this.attachmentService.GetFile(id);
            ...
            return this.File(file.FileStream, file.ContentType);
        }
        ...
        {
            var attachmentModel = await this.attachmentService.UploadFile(file.OpenReadStream(), file.FileName);
